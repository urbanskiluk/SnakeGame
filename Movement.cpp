...
Movement::Movement()
{
    ...
    textureOfHead.loadFromFile("head.png");
...
void Movement::displayPoints()
{
    ...
    fontOfGameOver.loadFromFile("Raleway-Black.ttf");
...
void Movement::buttonOfGameOverDisplay(sf::RenderWindow &window, sf::Event &event, std::vector<std::shared_ptr<Enemy>> &enemies,
                                       Obstacles &obstacles)
{
